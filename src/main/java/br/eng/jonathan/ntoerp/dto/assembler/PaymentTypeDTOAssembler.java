...
import br.eng.jonathan.ntoerp.controller.PaymentTypeController; // Ajustado para o controller correto
...
public class PaymentTypeDTOAssembler implements RepresentationModelAssembler<PaymentType, EntityModel<PaymentTypeDTO>> {
    ...
    public EntityModel<PaymentTypeDTO> toModel(PaymentType pt) {
        ...
        return EntityModel.of(dto,
                ...
                linkTo(methodOn(PaymentTypeController.class).listPaymentType(null)).withRel("list").withType("GET"),
                linkTo(methodOn(PaymentTypeController.class).createPaymentType(null)).withRel("create").withType("POST"),
